...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    loadExpenses();
    // Vérification automatique toutes les 2 secondes pour une synchro instantanée avec /driver
  ...
  return (
    <main style={{ padding: "20px", fontFamily: "sans-serif", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <div style={{ background: "#fff", padding: "15px", borderRadius: "8px", border: "1px solid #ddd" }}>
        ...
        {expenses.length === 0 ? (
          <p style={{ color: "#777", fontStyle: "italic" }}>Aucun ticket reçu pour le moment. Envoyez un test depuis l'interface chauffeur !</p>
        ) : (
