...
export default function DriverPage() {
  ...
  const [rentalType, setRentalType] = useState('courte'); // 'courte' ou 'longue'
  ...
  const handleSend = async () => {
    ...
    try {
      await fetch(https://script.google.com/macros/s/AKfycbz3toxMG7GneWerN16YxlhKV-0RlPV_FmeV4aVEWVExrH2typhuq-LHZM4T28-02iNL0A/exec, {
        method: 'POST',
        mode: 'no-cors',
